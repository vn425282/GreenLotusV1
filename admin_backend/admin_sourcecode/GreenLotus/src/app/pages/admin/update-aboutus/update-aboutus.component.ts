...
export class UpdateAboutUsComponent implements OnInit {
  ...
  @ViewChild('editorDescption') editorDescption: QuillEditorComponent;
      ...
      this.activatedRoute.params.subscribe((params: Params) => {
        ...
        this._p.getAboutUs().subscribe(data => {
          ...
          if (this.myCurrentAboutUs) {
            ...
            this.editorDescption.writeValue(this.myCurrentAboutUs.Description)
  ...
  updateAboutUs() {
    console.log(this.editorOurMission.content);
    let s = new AboutUs();
    s.ourmission = this.editorOurMission.content;
    s.idAboutUs = this.myCurrentAboutUs.ID_AboutUs;
    s.whychoose = this.editorWhyChoose.content;
    s.description = this.editorDescption.content;
